...
class Comment(models.Model):
    고투웍=models.CharField(max_length=300, blank=True, null=True)
    구내식당=models.CharField(max_length=300, blank=True, null=True)
    롤링파스타=models.CharField(max_length=300, blank=True, null=True)
    돌배기집=models.CharField(max_length=300, blank=True, null=True)
    리춘시장=models.CharField(max_length=300, blank=True, null=True)
    막이오름=models.CharField(max_length=300, blank=True, null=True)
    미정국수=models.CharField(max_length=300, blank=True, null=True)
    백S비빔밥=models.CharField(max_length=300, blank=True, null=True)
    백스비어=models.CharField(max_length=300, blank=True, null=True)
    백철판0410=models.CharField(max_length=300, blank=True, null=True)
    본가=models.CharField(max_length=300, blank=True, null=True)
    분식9단=models.CharField(max_length=300, blank=True, null=True)
    빽다방=models.CharField(max_length=300, blank=True, null=True)
    빽보이피자=models.CharField(max_length=300, blank=True, null=True)
    새마을식당=models.CharField(max_length=300, blank=True, null=True)
    성성식당=models.CharField(max_length=300, blank=True, null=True)
    역전우동0410=models.CharField(max_length=300, blank=True, null=True)
    연돈볼카츠=models.CharField(max_length=300, blank=True, null=True)
    원조쌈밥집=models.CharField(max_length=300, blank=True, null=True)
    인생설렁탕=models.CharField(max_length=300, blank=True, null=True)
    제순식당=models.CharField(max_length=300, blank=True, null=True)
    한신포차=models.CharField(max_length=300, blank=True, null=True)
    홍콩반점=models.CharField(max_length=300, blank=True, null=True)
...
#     click = models.CharField(max_length=45, blank=True, null=True)
